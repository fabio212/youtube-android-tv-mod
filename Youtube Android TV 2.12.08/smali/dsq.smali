...
.method public static a(Lgib;)Z
    .locals 0

    if-eqz p0, :cond_0

    iget-object p0, p0, Lgib;->a:Lewi;
...
.method public static b(Lafq;)Z
    ...
    iget-object p0, p0, Lafg;->a:Lafh;

    goto :goto_0

    .line 4
    :cond_1
    instance-of v0, p0, Lafo;
...
.method public static c(Ljava/lang/String;)[[Ljava/security/cert/X509Certificate;
    ...
    .line 3
    invoke-static {v1, v6}, Lebz;->a(Ljava/io/RandomAccessFile;I)Landroid/util/Pair;
    ...
    .line 4
    invoke-static {v1, v0}, Lebz;->a(Ljava/io/RandomAccessFile;I)Landroid/util/Pair;
    ...
    .line 9
    :goto_1
    invoke-static {v15}, Lebz;->b(Ljava/nio/ByteBuffer;)V
    ...
    .line 11
    invoke-static {v15, v0}, Lebz;->c(Ljava/nio/ByteBuffer;I)J
    ...
    .line 62
    invoke-static {v0, v5}, Ldsq;->k(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
    ...
    invoke-direct/range {v7 .. v15}, Laex;-><init>(Ljava/nio/ByteBuffer;JJJLjava/nio/ByteBuffer;)V
    ...
    invoke-static {v2, v0}, Ldsq;->d(Ljava/nio/channels/FileChannel;Laex;)[[Ljava/security/cert/X509Certificate;
    ...
    invoke-direct {v4, v0}, Laey;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v0, v2}, Laey;-><init>(Ljava/lang/String;)V
...
.method private static d(Ljava/nio/channels/FileChannel;Laex;)[[Ljava/security/cert/X509Certificate;
    .locals 10
    ...
    :try_start_1
    iget-object v2, p1, Laex;->a:Ljava/nio/ByteBuffer;

    .line 5
    invoke-static {v2}, Ldsq;->l(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    .line 9
    invoke-static {v4, v0, v1}, Ldsq;->e(Ljava/nio/ByteBuffer;Ljava/util/Map;Ljava/security/cert/CertificateFactory;)[Ljava/security/cert/X509Certificate;
    ...
    .line 6
    iget-wide v2, p1, Laex;->b:J

    iget-wide v4, p1, Laex;->c:J

    iget-wide v6, p1, Laex;->d:J

    iget-object v8, p1, Laex;->e:Ljava/nio/ByteBuffer;

    .line 14
    move-object v1, p0

    invoke-static/range {v0 .. v8}, Ldsq;->f(Ljava/util/Map;Ljava/nio/channels/FileChannel;JJJLjava/nio/ByteBuffer;)V
...
.method private static e(Ljava/nio/ByteBuffer;Ljava/util/Map;Ljava/security/cert/CertificateFactory;)[Ljava/security/cert/X509Certificate;
    .locals 22
    ...
    .line 1
    invoke-static/range {p0 .. p0}, Ldsq;->l(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    .line 3
    invoke-static/range {p0 .. p0}, Ldsq;->m(Ljava/nio/ByteBuffer;)[B
    ...
    .line 6
    :try_start_0
    invoke-static {v1}, Ldsq;->l(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    .line 10
    invoke-static {v5}, Ldsq;->h(I)I

    move-result v11

    .line 11
    invoke-static {v7}, Ldsq;->h(I)I
    ...
    .line 12
    :cond_1
    invoke-static {v10}, Ldsq;->m(Ljava/nio/ByteBuffer;)[B
    ...
    .line 34
    invoke-static {v0}, Ldsq;->l(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    .line 41
    invoke-static {v8}, Ldsq;->m(Ljava/nio/ByteBuffer;)[B
    ...
    .line 65
    invoke-static {v1}, Ldsq;->i(I)Ljava/lang/String;
    ...
    .line 52
    invoke-static {v0}, Ldsq;->m(Ljava/nio/ByteBuffer;)[B
    ...
    .line 55
    invoke-direct {v7, v5, v4}, Laez;-><init>(Ljava/security/cert/X509Certificate;[B)V
...
.method private static f(Ljava/util/Map;Ljava/nio/channels/FileChannel;JJJLjava/nio/ByteBuffer;)V
    .locals 15
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v1 .. v6}, Laew;-><init>(Ljava/nio/channels/FileChannel;JJ)V
    ...
    invoke-direct/range {v9 .. v14}, Laew;-><init>(Ljava/nio/channels/FileChannel;JJ)V
    ...
    .line 7
    invoke-static {v2}, Lebz;->b(Ljava/nio/ByteBuffer;)V
    ...
    .line 11
    invoke-direct {v3, v2}, Laeu;-><init>(Ljava/nio/ByteBuffer;)V
    ...
    .line 15
    invoke-static {v4, v5}, Ldsq;->g([I[Laev;)[[B
...
.method private static g([I[Laev;)[[B
    .locals 26
    ...
    .line 8
    invoke-static {v4, v10}, Ldsq;->n(I[B)V
    ...
    .line 11
    invoke-static {v13}, Ldsq;->i(I)Ljava/lang/String;
    ...
    .line 16
    invoke-static {v2, v4}, Ldsq;->n(I[B)V
    ...
    :try_start_1
    invoke-interface {v3, v6, v7, v8, v2}, Laev;->b([Ljava/security/MessageDigest;JI)V
    :try_end_1
    ...
    .line 28
    invoke-static {v2}, Ldsq;->i(I)Ljava/lang/String;
...
.method private static l(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    .line 7
    invoke-static {p0, v0}, Ldsq;->k(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
...
.method private static m(Ljava/nio/ByteBuffer;)[B
    .locals 4
