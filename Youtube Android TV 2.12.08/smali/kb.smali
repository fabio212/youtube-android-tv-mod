...
# direct methods
.method public constructor <init>(Lmh;Ljava/util/ArrayList;)V
    .locals 0

    iput-object p1, p0, Lkb;->b:Lmh;
...
.method public final run()V
    ...
    iget-object v4, p0, Lkb;->b:Lmh;

    .line 2
    iget-object v5, v3, Lki;->a:Lmz;
    ...
    .line 14
    :cond_0
    iget-object v5, v5, Lmz;->a:Landroid/view/View;

    .line 3
    :goto_1
    iget-object v7, v3, Lki;->b:Lmz;

    if-eqz v7, :cond_1

    iget-object v6, v7, Lmz;->a:Landroid/view/View;
    ...
    iget-object v11, v4, Lmh;->m:Ljava/util/ArrayList;

    .line 5
    iget-object v12, v3, Lki;->a:Lmz;
    ...
    invoke-direct {v12, v4, v3, v10, v5}, Lkg;-><init>(Lmh;Lki;Landroid/view/ViewPropertyAnimator;Landroid/view/View;)V
    ...
    iget-object v10, v4, Lmh;->m:Ljava/util/ArrayList;

    .line 11
    iget-object v11, v3, Lki;->b:Lmz;
    ...
    invoke-direct {v8, v4, v3, v5, v6}, Lkh;-><init>(Lmh;Lki;Landroid/view/ViewPropertyAnimator;Landroid/view/View;)V
    ...
    iget-object v0, p0, Lkb;->b:Lmh;

    iget-object v0, v0, Lmh;->i:Ljava/util/ArrayList;

    iget-object v1, p0, Lkb;->a:Ljava/util/ArrayList;
