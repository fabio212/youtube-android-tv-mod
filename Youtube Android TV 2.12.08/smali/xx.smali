...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lxx;->a:Landroid/graphics/Matrix;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lxx;->o:Landroid/graphics/Matrix;
    ...
    iput-object v0, p0, Lxx;->j:Ljava/lang/String;

    iput-object v0, p0, Lxx;->k:Ljava/lang/Boolean;
    ...
    iput-object v0, p0, Lxx;->m:Landroid/graphics/Path;
    ...
    iput-object v0, p0, Lxx;->n:Landroid/graphics/Path;
...
.method public constructor <init>(Lxx;)V
    ...
    .line 8
    iget-object v2, p1, Lxx;->d:Lxv;

    invoke-direct {v1, v2, v0}, Lxv;-><init>(Lxv;Loz;)V

    iput-object v1, p0, Lxx;->d:Lxv;

    new-instance v1, Landroid/graphics/Path;

    .line 9
    iget-object v2, p1, Lxx;->m:Landroid/graphics/Path;

    invoke-direct {v1, v2}, Landroid/graphics/Path;-><init>(Landroid/graphics/Path;)V

    iput-object v1, p0, Lxx;->m:Landroid/graphics/Path;

    new-instance v1, Landroid/graphics/Path;

    .line 10
    iget-object v2, p1, Lxx;->n:Landroid/graphics/Path;

    invoke-direct {v1, v2}, Landroid/graphics/Path;-><init>(Landroid/graphics/Path;)V

    iput-object v1, p0, Lxx;->n:Landroid/graphics/Path;
    ...
    .line 17
    iget-object v1, p1, Lxx;->j:Ljava/lang/String;

    iput-object v1, p0, Lxx;->j:Ljava/lang/String;
    ...
    .line 19
    invoke-virtual {v0, v1, p0}, Lpi;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 20
    :cond_0
    iget-object p1, p1, Lxx;->k:Ljava/lang/Boolean;

    iput-object p1, p0, Lxx;->k:Ljava/lang/Boolean;
...
# virtual methods
.method public final a(Lxv;Landroid/graphics/Matrix;Landroid/graphics/Canvas;II)V
    .locals 18
    ...
    iget-object v0, v7, Lxv;->a:Landroid/graphics/Matrix;
    ...
    iget-object v1, v7, Lxv;->j:Landroid/graphics/Matrix;
    ...
    .line 4
    :goto_0
    iget-object v0, v7, Lxv;->b:Ljava/util/ArrayList;
    ...
    .line 8
    iget-object v2, v7, Lxv;->a:Landroid/graphics/Matrix;
    ...
    invoke-virtual/range {v0 .. v5}, Lxx;->a(Lxv;Landroid/graphics/Matrix;Landroid/graphics/Canvas;II)V
    ...
    .line 12
    iget-object v11, v7, Lxv;->a:Landroid/graphics/Matrix;

    iget-object v12, v6, Lxx;->o:Landroid/graphics/Matrix;
    ...
    iget-object v2, v6, Lxx;->m:Landroid/graphics/Path;

    .line 20
    invoke-virtual {v2}, Landroid/graphics/Path;->reset()V

    iget-object v11, v0, Lxw;->m:[Lbj;

    if-eqz v11, :cond_2

    .line 21
    invoke-static {v11, v2}, Lbj;->a([Lbj;Landroid/graphics/Path;)V

    :cond_2
    iget-object v2, v6, Lxx;->m:Landroid/graphics/Path;

    iget-object v11, v6, Lxx;->n:Landroid/graphics/Path;

    .line 22
    invoke-virtual {v11}, Landroid/graphics/Path;->reset()V

    .line 23
    invoke-virtual {v0}, Lxw;->a()Z

    move-result v11

    if-eqz v11, :cond_4

    iget-object v4, v6, Lxx;->n:Landroid/graphics/Path;
    ...
    iget-object v0, v6, Lxx;->n:Landroid/graphics/Path;

    iget-object v4, v6, Lxx;->o:Landroid/graphics/Matrix;
    ...
    iget-object v12, v6, Lxx;->p:Landroid/graphics/PathMeasure;
    ...
    iput-object v12, v6, Lxx;->p:Landroid/graphics/PathMeasure;

    :cond_6
    iget-object v12, v6, Lxx;->p:Landroid/graphics/PathMeasure;

    iget-object v13, v6, Lxx;->m:Landroid/graphics/Path;
    ...
    iget-object v13, v6, Lxx;->p:Landroid/graphics/PathMeasure;
    ...
    iget-object v11, v6, Lxx;->p:Landroid/graphics/PathMeasure;
    ...
    iget-object v13, v6, Lxx;->c:Landroid/graphics/Paint;
    ...
    iput-object v13, v6, Lxx;->c:Landroid/graphics/Paint;
    ...
    .line 44
    invoke-virtual {v2}, Lau;->b()Z

    move-result v14

    if-eqz v14, :cond_a

    iget-object v2, v2, Lau;->a:Landroid/graphics/Shader;

    iget-object v14, v6, Lxx;->o:Landroid/graphics/Matrix;
    ...
    invoke-static {v2, v14}, Lya;->c(IF)I
    ...
    iget-object v2, v6, Lxx;->n:Landroid/graphics/Path;
    ...
    iget-object v13, v6, Lxx;->b:Landroid/graphics/Paint;
    ...
    iput-object v13, v6, Lxx;->b:Landroid/graphics/Paint;
    ...
    .line 58
    iget-object v14, v0, Lxu;->k:Landroid/graphics/Paint$Join;
    ...
    .line 60
    :cond_e
    iget-object v14, v0, Lxu;->j:Landroid/graphics/Paint$Cap;
    ...
    invoke-static {v2, v4}, Lya;->c(IF)I
...
.method public getAlpha()F
    ...
    invoke-virtual {p0}, Lxx;->getRootAlpha()I
...
.method public setAlpha(F)V
    ...
    .line 1
    invoke-virtual {p0, p1}, Lxx;->setRootAlpha(I)V
