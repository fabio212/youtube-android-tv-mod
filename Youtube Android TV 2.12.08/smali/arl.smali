...
.method public final a(Ljava/lang/String;Lorg/json/JSONObject;Lbgq;)V
    ...
    iget-object v0, p0, Larl;->a:Lasj;

    invoke-static {p2}, Lapr;->c(Lorg/json/JSONObject;)Lapr;
    ...
    iget-object v2, v1, Lapr;->b:Laoj;

    iput-object p2, v2, Laoj;->c:Laqm;

    iget-object p2, v0, Lasj;->b:Laqp;

    invoke-interface {p2, p1, v1, p3}, Laqp;->s(Ljava/lang/String;Lapr;Lbgq;)V
