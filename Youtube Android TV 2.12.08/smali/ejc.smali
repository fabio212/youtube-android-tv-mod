...
.method public static c(Ljava/util/Set;Ljava/util/Set;)Lejb;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    .line 1
    invoke-direct {v0, p0, p1}, Leiz;-><init>(Ljava/util/Set;Ljava/util/Set;)V
...
.method static g(Ljava/util/Set;Ljava/util/Collection;)Z
    ...
    invoke-interface {p1}, Leim;->a()Ljava/util/Set;
    ...
    invoke-static {p0, p1}, Leic;->d(Ljava/util/Iterator;Ljava/util/Collection;)Z
...
.method static h(Leik;Ljava/io/ObjectOutputStream;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
...
.method static i(Ljava/lang/Class;Ljava/lang/String;)Leiy;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 2
    invoke-direct {p1, p0}, Leiy;-><init>(Ljava/lang/reflect/Field;)V
    :try_end_0
...
.method public static k(Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static {p0, v0}, Lejc;->j(Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
