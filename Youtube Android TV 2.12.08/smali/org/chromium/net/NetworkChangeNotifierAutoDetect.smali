...
# instance fields
.field private mConnectivityManagerDelegate:Lhgc;

.field private mDefaultNetworkCallback:Lhgd;
...
.field private mNetworkCallback:Lhgj;
...
.field private mWifiManagerDelegate:Lhgk;
...
.method public constructor <init>(Lorg/chromium/net/NetworkChangeNotifierAutoDetect$Observer;Lorg/chromium/net/NetworkChangeNotifierAutoDetect$RegistrationPolicy;)V
    ...
    .line 4
    invoke-direct {p1, v0}, Lhgc;-><init>(Landroid/content/Context;)V

    iput-object p1, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->mConnectivityManagerDelegate:Lhgc;
    ...
    .line 5
    invoke-direct {p1, v0}, Lhgk;-><init>(Landroid/content/Context;)V

    iput-object p1, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->mWifiManagerDelegate:Lhgk;
    ...
    .line 7
    invoke-direct {p1, p0}, Lhgj;-><init>(Lorg/chromium/net/NetworkChangeNotifierAutoDetect;)V

    iput-object p1, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->mNetworkCallback:Lhgj;
    ...
    .line 12
    invoke-direct {p1, p0}, Lhgd;-><init>(Lorg/chromium/net/NetworkChangeNotifierAutoDetect;)V
    ...
    .line 12
    :goto_0
    iput-object p1, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->mDefaultNetworkCallback:Lhgd;
...
.method public static synthetic access$100(Lhgc;Landroid/net/Network;)[Landroid/net/Network;
    .locals 0

    invoke-static {p0, p1}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->getAllNetworksFiltered(Lhgc;Landroid/net/Network;)[Landroid/net/Network;
...
.method public static synthetic access$400(Lorg/chromium/net/NetworkChangeNotifierAutoDetect;)Lhgc;
    .locals 0

    iget-object p0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->mConnectivityManagerDelegate:Lhgc;

    return-object p0
.end method

.method public static synthetic access$500(Lorg/chromium/net/NetworkChangeNotifierAutoDetect;)Lorg/chromium/net/NetworkChangeNotifierAutoDetect$Observer;
    .locals 0
...
.method public static synthetic access$600(Lorg/chromium/net/NetworkChangeNotifierAutoDetect;Ljava/lang/Runnable;)V
    .locals 0
...
.method public static synthetic access$900(Lorg/chromium/net/NetworkChangeNotifierAutoDetect;)Z
    .locals 0
...
.method public static synthetic access$902(Lorg/chromium/net/NetworkChangeNotifierAutoDetect;Z)Z
    .locals 0
...
.method private connectionTypeChanged()V
    ...
    .line 5
    invoke-virtual {v0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect$NetworkState;->getPrivateDnsServerName()Ljava/lang/String;
    ...
    .line 6
    invoke-virtual {v2}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect$NetworkState;->getPrivateDnsServerName()Ljava/lang/String;
...
.method private static getAllNetworksFiltered(Lhgc;Landroid/net/Network;)[Landroid/net/Network;
    .locals 8

    iget-object v0, p0, Lhgc;->a:Landroid/net/ConnectivityManager;
    ...
    .line 4
    :cond_1
    invoke-virtual {p0, v5}, Lhgc;->b(Landroid/net/Network;)Landroid/net/NetworkCapabilities;
    ...
    .line 7
    invoke-static {v5}, Lhgc;->e(Landroid/net/Network;)Z
...
.method public getCurrentNetworkState()Lorg/chromium/net/NetworkChangeNotifierAutoDetect$NetworkState;
    ...
    iget-object v0, v1, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->mConnectivityManagerDelegate:Lhgc;

    iget-object v2, v1, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->mWifiManagerDelegate:Lhgk;
    ...
    .line 1
    invoke-virtual {v0}, Lhgc;->d()Landroid/net/Network;

    move-result-object v3

    iget-object v0, v0, Lhgc;->a:Landroid/net/ConnectivityManager;
    ...
    :try_start_0
    iget-boolean v0, v2, Lhgk;->c:Z

    if-eqz v0, :cond_8

    iget-boolean v0, v2, Lhgk;->d:Z

    goto :goto_4

    .line 25
    :cond_8
    iget-object v0, v2, Lhgk;->a:Landroid/content/Context;
    ...
    iget-object v8, v2, Lhgk;->a:Landroid/content/Context;
    ...
    :goto_3
    iput-object v0, v2, Lhgk;->e:Landroid/net/wifi/WifiManager;

    iput-boolean v5, v2, Lhgk;->c:Z
    ...
    :try_start_1
    iget-object v0, v2, Lhgk;->e:Landroid/net/wifi/WifiManager;
...
.method public getDefaultNetId()J
    ...
    iget-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->mConnectivityManagerDelegate:Lhgc;
...
.method public getNetworksAndTypes()[J
    ...
    invoke-static {v0, v1}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->getAllNetworksFiltered(Lhgc;Landroid/net/Network;)[Landroid/net/Network;
    ...
    iget-object v7, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->mConnectivityManagerDelegate:Lhgc;

    .line 5
    invoke-virtual {v7, v5}, Lhgc;->a(Landroid/net/Network;)I
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 1
    invoke-direct {p1, p0}, Lhgb;-><init>(Lorg/chromium/net/NetworkChangeNotifierAutoDetect;)V
...
.method public register()V
    ...
    :cond_1
    iget-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->mDefaultNetworkCallback:Lhgd;
    ...
    :try_start_0
    iget-object v2, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->mConnectivityManagerDelegate:Lhgc;

    iget-object v3, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->mHandler:Landroid/os/Handler;

    iget-object v2, v2, Lhgc;->a:Landroid/net/ConnectivityManager;
    ...
    iput-object v1, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->mDefaultNetworkCallback:Lhgd;
    ...
    iget-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->mNetworkCallback:Lhgj;

    if-eqz v0, :cond_8

    iget-object v4, v0, Lhgj;->b:Lorg/chromium/net/NetworkChangeNotifierAutoDetect;

    .line 5
    invoke-static {v4}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->access$400(Lorg/chromium/net/NetworkChangeNotifierAutoDetect;)Lhgc;

    move-result-object v4

    invoke-static {v4, v1}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->access$100(Lhgc;Landroid/net/Network;)[Landroid/net/Network;

    move-result-object v4

    iput-object v1, v0, Lhgj;->a:Landroid/net/Network;
    ...
    iget-object v5, v0, Lhgj;->b:Lorg/chromium/net/NetworkChangeNotifierAutoDetect;

    .line 7
    invoke-static {v5}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->access$400(Lorg/chromium/net/NetworkChangeNotifierAutoDetect;)Lhgc;

    move-result-object v5

    aget-object v6, v4, v2

    invoke-virtual {v5, v6}, Lhgc;->b(Landroid/net/Network;)Landroid/net/NetworkCapabilities;
    ...
    iput-object v4, v0, Lhgj;->a:Landroid/net/Network;
    ...
    iget-object v5, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->mNetworkCallback:Lhgj;
    ...
    iput-object v1, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->mNetworkCallback:Lhgj;
...
.method setConnectivityManagerDelegateForTests(Lhgc;)V
    .locals 0
...
.method setWifiManagerDelegateForTests(Lhgk;)V
    .locals 0
...
.method public unregister()V
    ...
    iget-object v1, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->mConnectivityManagerDelegate:Lhgc;

    .line 1
    invoke-virtual {v1, v0}, Lhgc;->c(Landroid/net/ConnectivityManager$NetworkCallback;)V
