...
.method public constructor <init>(Lorg/chromium/net/impl/CronetUrlRequestContext;Ljava/lang/String;ILorg/chromium/net/BidirectionalStream$Callback;Ljava/util/concurrent/Executor;Ljava/lang/String;Ljava/util/List;ZLjava/util/Collection;ZIZI)V
    ...
    invoke-direct {v1, p4}, Lhki;-><init>(Lorg/chromium/net/BidirectionalStream$Callback;)V

    iput-object v1, v0, Lorg/chromium/net/impl/CronetBidirectionalStream;->a:Lhki;
...
.method private final h(Ljava/lang/Runnable;)V
    ...
    invoke-static {v0, p1, v1}, Lhez;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 3
    invoke-direct {p0, v2}, Lorg/chromium/net/impl/CronetBidirectionalStream;->i(Z)V
...
.method private final i(Z)V
    ...
    invoke-static {v0, v1, v2}, Lhez;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 3
    invoke-virtual {p1}, Lorg/chromium/net/impl/CronetUrlRequestContext;->e()V
...
.method private final j(Lorg/chromium/net/CronetException;)V
    ...
    .line 1
    invoke-direct {v0, p0, p1}, Lhhe;-><init>(Lorg/chromium/net/impl/CronetBidirectionalStream;Lorg/chromium/net/CronetException;)V

    invoke-direct {p0, v0}, Lorg/chromium/net/impl/CronetBidirectionalStream;->h(Ljava/lang/Runnable;)V
...
.method private onCanceled()V
    ...
    .line 1
    invoke-direct {v0, p0}, Lhhd;-><init>(Lorg/chromium/net/impl/CronetBidirectionalStream;)V
...
.method private onError(IIILjava/lang/String;J)V
    ...
    iget-object v0, p0, Lorg/chromium/net/impl/CronetBidirectionalStream;->g:Lhkg;
    ...
    invoke-direct {p3, p4, p1, p2}, Lhgy;-><init>(Ljava/lang/String;II)V

    invoke-direct {p0, p3}, Lorg/chromium/net/impl/CronetBidirectionalStream;->j(Lorg/chromium/net/CronetException;)V
    ...
    invoke-direct {p5, p4, p1, p2, p3}, Lhkb;-><init>(Ljava/lang/String;III)V

    invoke-direct {p0, p5}, Lorg/chromium/net/impl/CronetBidirectionalStream;->j(Lorg/chromium/net/CronetException;)V
...
.method private onMetricsCollected(JJJJJJJJJJJJJZJJ)V
    ...
    iget-object v7, v1, Lorg/chromium/net/impl/CronetBidirectionalStream;->g:Lhkg;
    ...
    invoke-direct/range {p1 .. p7}, Lhkc;-><init>(Ljava/lang/String;Ljava/util/Collection;Lorg/chromium/net/RequestFinishedInfo$Metrics;ILorg/chromium/net/UrlResponseInfo;Lorg/chromium/net/CronetException;)V

    iget-object v0, v1, Lorg/chromium/net/impl/CronetBidirectionalStream;->h:Lorg/chromium/net/impl/CronetUrlRequestContext;

    .line 3
    invoke-virtual {v0, v3}, Lorg/chromium/net/impl/CronetUrlRequestContext;->g(Lorg/chromium/net/RequestFinishedInfo;)V
...
.method private onReadCompleted(Ljava/nio/ByteBuffer;IIIJ)V
    ...
    iget-object p3, p0, Lorg/chromium/net/impl/CronetBidirectionalStream;->y:Lhhf;

    iput-object p1, p3, Lhhf;->a:Ljava/nio/ByteBuffer;
    ...
    .line 5
    :goto_0
    iput-boolean p1, p3, Lhhf;->b:Z

    .line 6
    invoke-direct {p0, p3}, Lorg/chromium/net/impl/CronetBidirectionalStream;->h(Ljava/lang/Runnable;)V
    ...
    invoke-direct {p1, p2, p6}, Lhhl;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private onResponseHeadersReceived(ILjava/lang/String;[Ljava/lang/String;J)V
    ...
    invoke-direct/range {v2 .. v11}, Lhkg;-><init>(Ljava/util/List;ILjava/lang/String;Ljava/util/List;ZLjava/lang/String;Ljava/lang/String;J)V

    iput-object v0, v1, Lorg/chromium/net/impl/CronetBidirectionalStream;->g:Lhkg;
    :try_end_0
    ...
    .line 4
    invoke-direct {v0, p0}, Lhhb;-><init>(Lorg/chromium/net/impl/CronetBidirectionalStream;)V
    ...
    invoke-direct {v0, v3, v2}, Lhhl;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private onResponseTrailersReceived([Ljava/lang/String;)V
    ...
    invoke-direct {v0, p1}, Lhkf;-><init>(Ljava/util/List;)V

    new-instance p1, Lhhc;

    .line 2
    invoke-direct {p1, p0, v0}, Lhhc;-><init>(Lorg/chromium/net/impl/CronetBidirectionalStream;Lorg/chromium/net/UrlResponseInfo$HeaderBlock;)V

    invoke-direct {p0, p1}, Lorg/chromium/net/impl/CronetBidirectionalStream;->h(Ljava/lang/Runnable;)V
...
.method private onStreamReady(Z)V
    ...
    .line 1
    invoke-direct {v0, p0, p1}, Lhha;-><init>(Lorg/chromium/net/impl/CronetBidirectionalStream;Z)V
...
.method private onWritevCompleted([Ljava/nio/ByteBuffer;[I[IZ)V
    ...
    :goto_1
    invoke-direct {v4, p0, v3, v2}, Lhhg;-><init>(Lorg/chromium/net/impl/CronetBidirectionalStream;Ljava/nio/ByteBuffer;Z)V

    invoke-direct {p0, v4}, Lorg/chromium/net/impl/CronetBidirectionalStream;->h(Ljava/lang/Runnable;)V
    ...
    .line 10
    invoke-direct {p1, p2, p3}, Lhhl;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final b()V
    ...
    :try_start_1
    iget-object v0, p0, Lorg/chromium/net/impl/CronetBidirectionalStream;->a:Lhki;

    iget-object v2, p0, Lorg/chromium/net/impl/CronetBidirectionalStream;->g:Lhkg;

    .line 5
    invoke-virtual {v0, p0, v2}, Lhki;->onSucceeded(Lorg/chromium/net/BidirectionalStream;Lorg/chromium/net/UrlResponseInfo;)V
    :try_end_1
    ...
    invoke-static {v2, v0, v3}, Lhez;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public final d(Lorg/chromium/net/CronetException;)V
    ...
    .line 4
    invoke-virtual {v0, p0, v2, p1}, Lhki;->onFailed(Lorg/chromium/net/BidirectionalStream;Lorg/chromium/net/UrlResponseInfo;Lorg/chromium/net/CronetException;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    ...
    invoke-static {v0, p1, v2}, Lhez;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public final e(Ljava/lang/Exception;)V
    ...
    .line 3
    invoke-virtual {p0, v0}, Lorg/chromium/net/impl/CronetBidirectionalStream;->d(Lorg/chromium/net/CronetException;)V
...
.method public final flush()V
    ...
    .line 9
    invoke-static {v1}, Lorg/chromium/net/impl/CronetBidirectionalStream;->c(Ljava/lang/String;)Z
...
.method public final read(Ljava/nio/ByteBuffer;)V
    ...
    :cond_0
    iget-object v1, p0, Lorg/chromium/net/impl/CronetBidirectionalStream;->y:Lhhf;
    ...
    .line 5
    invoke-direct {v1, p0}, Lhhf;-><init>(Lorg/chromium/net/impl/CronetBidirectionalStream;)V

    iput-object v1, p0, Lorg/chromium/net/impl/CronetBidirectionalStream;->y:Lhhf;
...
.method public final start()V
    ...
    .line 5
    invoke-static {v7}, Lorg/chromium/net/impl/CronetBidirectionalStream;->c(Ljava/lang/String;)Z
