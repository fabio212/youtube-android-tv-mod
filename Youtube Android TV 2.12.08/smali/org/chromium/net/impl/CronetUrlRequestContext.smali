...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/chromium/net/impl/CronetUrlRequestContext;->b:Ljava/lang/String;
...
.method public constructor <init>(Lhhk;)V
    ...
    invoke-direct/range {p0 .. p0}, Lhhh;-><init>()V
    ...
    iput-object v3, v1, Lorg/chromium/net/impl/CronetUrlRequestContext;->f:Landroid/os/ConditionVariable;
    ...
    iput-object v3, v1, Lorg/chromium/net/impl/CronetUrlRequestContext;->g:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v3, Ljava/lang/Object;

    invoke-direct {v3}, Ljava/lang/Object;-><init>()V

    iput-object v3, v1, Lorg/chromium/net/impl/CronetUrlRequestContext;->i:Ljava/lang/Object;
    ...
    iput v4, v1, Lorg/chromium/net/impl/CronetUrlRequestContext;->k:I

    const/4 v3, -0x1

    iput v3, v1, Lorg/chromium/net/impl/CronetUrlRequestContext;->l:I
    ...
    iput-object v3, v1, Lorg/chromium/net/impl/CronetUrlRequestContext;->o:Lhfc;
    ...
    iput-object v3, v1, Lorg/chromium/net/impl/CronetUrlRequestContext;->p:Lhfc;
    ...
    iput-object v3, v1, Lorg/chromium/net/impl/CronetUrlRequestContext;->q:Ljava/util/Map;

    iget-boolean v3, v0, Lhhk;->n:Z

    iput-boolean v3, v1, Lorg/chromium/net/impl/CronetUrlRequestContext;->h:Z

    iget-object v3, v0, Lhhk;->a:Landroid/content/Context;

    .line 6
    invoke-static {v3, v0}, Lorg/chromium/net/impl/CronetLibraryLoader;->a(Landroid/content/Context;Lhhk;)V
    ...
    iget-object v3, v0, Lhhk;->f:Ljava/lang/String;

    iput-object v3, v1, Lorg/chromium/net/impl/CronetUrlRequestContext;->t:Ljava/lang/String;

    sget-object v4, Lorg/chromium/net/impl/CronetUrlRequestContext;->s:Ljava/util/HashSet;
    ...
    :try_start_1
    iget-object v4, v0, Lhhk;->e:Ljava/lang/String;

    iget-object v5, v0, Lhhk;->f:Ljava/lang/String;

    iget-boolean v6, v0, Lhhk;->g:Z
    ...
    .line 14
    invoke-static {v7}, Lhkh;->b(Ljava/lang/StringBuilder;)V
    ...
    .line 15
    :goto_1
    iget-boolean v8, v0, Lhhk;->h:Z

    iget-boolean v9, v0, Lhhk;->i:Z

    iget-boolean v10, v0, Lhhk;->j:Z

    iget v11, v0, Lhhk;->k:I

    iget-wide v12, v0, Lhhk;->l:J

    iget-object v14, v0, Lhhk;->m:Ljava/lang/String;

    iget-boolean v3, v0, Lhhk;->n:Z

    iget-boolean v15, v0, Lhhk;->d:Z
    ...
    .line 16
    invoke-virtual {v0, v15}, Lhhk;->b(I)I
    ...
    iget-object v5, v0, Lhhk;->b:Ljava/util/List;
    ...
    .line 19
    iget-object v7, v6, Lhhj;->a:Ljava/lang/String;
    ...
    :cond_3
    iget-object v0, v0, Lhhk;->c:Ljava/util/List;
    ...
    .line 22
    iget-object v6, v5, Lhhi;->a:Ljava/lang/String;

    iget-object v7, v5, Lhhi;->b:[[B

    iget-boolean v8, v5, Lhhi;->c:Z

    iget-object v5, v5, Lhhi;->d:Ljava/util/Date;
    ...
    .line 28
    invoke-direct {v0, v1}, Lhic;-><init>(Lorg/chromium/net/impl/CronetUrlRequestContext;)V
...
.method private static j(Ljava/util/concurrent/Executor;Ljava/lang/Runnable;)V
    .locals 2
    ...
    invoke-static {p1, p0, v0}, Lhez;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private onRttObservation(IJI)V
    ...
    :try_start_0
    iget-object v1, p0, Lorg/chromium/net/impl/CronetUrlRequestContext;->o:Lhfc;

    .line 1
    invoke-virtual {v1}, Lhfc;->iterator()Ljava/util/Iterator;
    ...
    invoke-direct/range {v3 .. v8}, Lhid;-><init>(Lhkk;IJI)V
    ...
    invoke-static {v2, v9}, Lorg/chromium/net/impl/CronetUrlRequestContext;->j(Ljava/util/concurrent/Executor;Ljava/lang/Runnable;)V
...
.method private onThroughputObservation(IJI)V
    ...
    :try_start_0
    iget-object v1, p0, Lorg/chromium/net/impl/CronetUrlRequestContext;->p:Lhfc;
    ...
    invoke-direct/range {v3 .. v8}, Lhie;-><init>(Lhkl;IJI)V
...
.method public final addRequestFinishedListener(Lorg/chromium/net/RequestFinishedInfo$Listener;)V
    ...
    .line 1
    invoke-direct {v2, p1}, Lhkm;-><init>(Lorg/chromium/net/RequestFinishedInfo$Listener;)V
...
.method public final addRttListener(Lorg/chromium/net/NetworkQualityRttListener;)V
    ...
    iget-boolean v0, p0, Lorg/chromium/net/impl/CronetUrlRequestContext;->h:Z
    ...
    .line 5
    invoke-direct {v2, p1}, Lhkk;-><init>(Lorg/chromium/net/NetworkQualityRttListener;)V

    invoke-virtual {v1, v2}, Lhfc;->d(Ljava/lang/Object;)V
...
.method public final addThroughputListener(Lorg/chromium/net/NetworkQualityThroughputListener;)V
    ...
    .line 5
    invoke-direct {v2, p1}, Lhkl;-><init>(Lorg/chromium/net/NetworkQualityThroughputListener;)V
...
.method public final createURLStreamHandlerFactory()Ljava/net/URLStreamHandlerFactory;
    ...
    invoke-direct {v0, p0}, Lhla;-><init>(Lorg/chromium/net/ExperimentalCronetEngine;)V
...
.method final d()V
    ...
    iget-object v0, p0, Lorg/chromium/net/impl/CronetUrlRequestContext;->g:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method final g(Lorg/chromium/net/RequestFinishedInfo;)V
    .locals 5
    ...
    .line 5
    invoke-direct {v4, v3, p1}, Lhif;-><init>(Lhkm;Lorg/chromium/net/RequestFinishedInfo;)V
    ...
    invoke-static {v3, v4}, Lorg/chromium/net/impl/CronetUrlRequestContext;->j(Ljava/util/concurrent/Executor;Ljava/lang/Runnable;)V
...
.method public final getEffectiveConnectionType()I
    ...
    :try_start_0
    iget v1, p0, Lorg/chromium/net/impl/CronetUrlRequestContext;->k:I
...
.method public final newBidirectionalStreamBuilder(Ljava/lang/String;Lorg/chromium/net/BidirectionalStream$Callback;Ljava/util/concurrent/Executor;)Lorg/chromium/net/ExperimentalBidirectionalStream$Builder;
    ...
    .line 1
    invoke-direct {v0, p1, p2, p3, p0}, Lhgx;-><init>(Ljava/lang/String;Lorg/chromium/net/BidirectionalStream$Callback;Ljava/util/concurrent/Executor;Lhhh;)V
...
.method public final openConnection(Ljava/net/URL;Ljava/net/Proxy;)Ljava/net/URLConnection;
    ...
    invoke-direct {p2, p1, p0}, Lhkw;-><init>(Ljava/net/URL;Lorg/chromium/net/CronetEngine;)V
...
.method public final removeRttListener(Lorg/chromium/net/NetworkQualityRttListener;)V
    ...
    invoke-virtual {v1, v2}, Lhfc;->a(Ljava/lang/Object;)Z

    move-result p1

    if-eqz p1, :cond_0

    iget-object p1, p0, Lorg/chromium/net/impl/CronetUrlRequestContext;->o:Lhfc;

    invoke-virtual {p1}, Lhfc;->b()Z
...
.method public final removeThroughputListener(Lorg/chromium/net/NetworkQualityThroughputListener;)V
    ...
    iget-object p1, p0, Lorg/chromium/net/impl/CronetUrlRequestContext;->p:Lhfc;
...
.method public final shutdown()V
    ...
    iget-object v1, p0, Lorg/chromium/net/impl/CronetUrlRequestContext;->g:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public final stopNetLog()V
    ...
    iput-object v1, p0, Lorg/chromium/net/impl/CronetUrlRequestContext;->r:Landroid/os/ConditionVariable;
