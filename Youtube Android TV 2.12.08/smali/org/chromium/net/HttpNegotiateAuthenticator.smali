...
.method public static synthetic access$100(Lorg/chromium/net/HttpNegotiateAuthenticator;Landroid/os/Bundle;Lhfz;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lorg/chromium/net/HttpNegotiateAuthenticator;->processResult(Landroid/os/Bundle;Lhfz;)V
...
.method private processResult(Landroid/os/Bundle;Lhfz;)V
    .locals 4
...
.method private requestTokenWithActivity(Landroid/content/Context;Landroid/app/Activity;Lhfz;[Ljava/lang/String;)V
    .locals 9
    ...
    invoke-static {p2, p4, p1}, Lhez;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    .line 3
    iget-wide p1, p3, Lhfz;->a:J
    ...
    .line 5
    :cond_2
    iget-object v0, p3, Lhfz;->b:Landroid/accounts/AccountManager;

    iget-object v1, p0, Lorg/chromium/net/HttpNegotiateAuthenticator;->mAccountType:Ljava/lang/String;

    iget-object v2, p3, Lhfz;->d:Ljava/lang/String;

    iget-object v6, p3, Lhfz;->c:Landroid/os/Bundle;

    new-instance v7, Lhfy;

    invoke-direct {v7, p0, p3}, Lhfy;-><init>(Lorg/chromium/net/HttpNegotiateAuthenticator;Lhfz;)V
...
.method private requestTokenWithoutActivity(Landroid/content/Context;Lhfz;[Ljava/lang/String;)V
    .locals 3
    ...
    invoke-static {p3, v0, p1}, Lhez;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    .line 3
    iget-wide p1, p2, Lhfz;->a:J
    ...
    .line 5
    :cond_0
    iget-object p1, p2, Lhfz;->b:Landroid/accounts/AccountManager;

    iget-object v0, p0, Lorg/chromium/net/HttpNegotiateAuthenticator;->mAccountType:Ljava/lang/String;

    new-instance v1, Lhfw;

    invoke-direct {v1, p0, p2}, Lhfw;-><init>(Lorg/chromium/net/HttpNegotiateAuthenticator;Lhfz;)V
...
.method getNextAuthToken(JLjava/lang/String;Ljava/lang/String;Z)V
    ...
    iput-object p3, v1, Lhfz;->d:Ljava/lang/String;
    ...
    iput-object p3, v1, Lhfz;->b:Landroid/accounts/AccountManager;

    iput-wide p1, v1, Lhfz;->a:J
    ...
    iput-object p2, v1, Lhfz;->c:Landroid/os/Bundle;

    if-eqz p4, :cond_0

    iget-object p2, v1, Lhfz;->c:Landroid/os/Bundle;
    ...
    iget-object p3, v1, Lhfz;->c:Landroid/os/Bundle;
    ...
    .line 7
    sget-object p2, Lorg/chromium/base/ApplicationStatus;->a:Lhep;

    .line 8
    invoke-direct {p0, v0, v1, p1}, Lorg/chromium/net/HttpNegotiateAuthenticator;->requestTokenWithoutActivity(Landroid/content/Context;Lhfz;[Ljava/lang/String;)V
