...
.method public static c(Ljava/util/concurrent/Executor;)Ljava/util/concurrent/Executor;
    ...
    invoke-direct {v0, p0}, Lert;-><init>(Ljava/util/concurrent/Executor;)V

    return-object v0
.end method

.method public static d(Ljava/util/concurrent/ExecutorService;)Lerj;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lero;-><init>(Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    .line 5
    invoke-direct {v0, p0}, Leov;-><init>(Ljava/util/concurrent/ExecutorService;)V
...
.method public static e(Ljava/util/concurrent/ScheduledExecutorService;)Lerk;
    .locals 1

    .line 1
    instance-of v0, p0, Lerk;
...
.method static f(Ljava/util/concurrent/Executor;Leou;)Ljava/util/concurrent/Executor;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    invoke-direct {v0, p0, p1}, Lerl;-><init>(Ljava/util/concurrent/Executor;Leou;)V
